            ...
            <section className="blog-list px-3 py-5 p-md-5">
                <div className="container">
                    <div>
                        ...
                        to it, still belong to Marta Pancaldi.
                    </p> <p>
                        Marta Pancaldi is committed to ensuring that the app is
                        ...
                        The Fiscal Code Calculator app stores and processes personal data that
                        ...
                        that the Fiscal Code Calculator app won’t work properly or at all.
                    </p>
                        <div><p>
                        ...
                        <p>
                            ...
                            Marta Pancaldi will not take responsibility for. Certain
                            functions of the app will require the app to have an active
                            internet connection. The connection can be Wi-Fi, or provided
                            by your mobile network provider, but Marta Pancaldi
                        ...
                        Along the same lines, Marta Pancaldi cannot always take
                        responsibility for the way you use the app i.e. You need to
                        make sure that your device stays charged – if it runs out of
                        battery and you can’t turn it on to avail the Service,
                        Marta Pancaldi cannot accept responsibility.
                    </p> <p>
                        With respect to Marta Pancaldi’s responsibility for your
                        use of the app, when you’re using the app, it’s important to
                        bear in mind that although we endeavour to ensure that it is
                        updated and correct at all times, we do rely on third parties
                        to provide information to us so that we can make it available
                        to you. Marta Pancaldi accepts no liability for any
                        ...
                        using the app. Marta Pancaldi does not promise that it
                        ...
                        <br/>
                        <h4>Terms & Conditions of the Fiscal Code</h4>
                        <p>
                            The only valid tax code is the one issued by the <i>Agenzia delle Entrate</i>,
                            the Italian Revenue Service.
                        </p>
                        <p>
                            The fiscal code generated is to be considered an example,
                            because in rare cases of homonymity and coincidence of personal data, the system generates
                            a non-univocal code. In the reality of the cases, this does not happen because the Italian
                            Inland Revenue replaces one of the characters with a letter to make all the assigned codes
                            unique.
                        </p>
                        <p>
                            The use for illegal purposes of a tax code is severely punished by law, therefore we decline
                            any responsibility for any misuse of the code calculated with <i>Compute your Fiscal
                            Code</i>.
                        </p>
                        <br/>
                        <hr/>
                        ...
                        relation to this
                        policy. The Personal Information that I collect is used for providing and improving the Service.
                        I will not use or share your information with
                        anyone except as described in this Privacy Policy.
                    </p> <p>
                        The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions,
                        which is accessible at
                        Fiscal Code Calculator unless otherwise defined in this Privacy Policy.
                        ...
                        <p>
                            ...
                            The data related to the generation or decoding of the fiscal code, that is:
                            <ul>
                                <li>first name</li>
                                <li>last name</li>
                                <li>gender</li>
                            ...
                            are not collected or stored, and are used exclusively to provide the service.
                        </p>
                        <div><p>
                        ...
                        and libraries that use
                        “cookies” to collect information and improve their services. You have the option to either
                        accept or refuse these cookies
                        and know when a cookie is being sent to your device. If you choose to refuse our cookies, you
                        ...
                        I do not knowingly collect personally identifiable information from children under 13. In the
                        case
                        I discover that a child under 13 has provided me with personal information, I immediately
                        delete this from our servers. If you are a parent or guardian and you are aware that your child
