...
const exportToImage = (domElement) => {
    console.log(domElement);
    html2canvas(domElement, {allowTaint: true}).then(function (canvas) {
...
function CV() {
    ...
    // render() {
    //     let hideShadowWhenPrinting = this.state.printMode ? '' : 'shadow-lg';

        const canvasRef = useRef();

        // console.log(hideShadowWhenPrinting);
        return (
            <div>
                ...
                <div>
                    <div className="container px-3 px-lg-5">
                        <div ref={canvasRef}>
                            ...
                            <article
                                className={`resume-wrapper mx-auto theme-bg-light p-4 mb-4 my-4`}>
                    ...
                    <button onClick={() => exportToImage(canvasRef.current)}>Export</button>
                    </div>
                    <Section/>
                </div>
